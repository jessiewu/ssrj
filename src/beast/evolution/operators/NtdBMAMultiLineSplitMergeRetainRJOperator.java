 ...
 */
public class NtdBMAMultiLineSplitMergeRetainRJOperator extends MultiLineSplitMergeRetainRJOperator implements Loggable {
    ...
    public NtdBMAMultiLineSplitMergeRetainRJOperator(){
        ...
        siteModelIndicatorDistrInput.setRule(Input.Validate.OPTIONAL);
    ...
    public double mergeParameter(ParameterList parameterList, int mergeIndex, ParametricDistribution distr) throws Exception{
        ...
        if(distr instanceof MultivariateNormal){
            ...
            //System.out.println("1: "+distr.calcLogP(new RealParameter(sampleVal)));
            //System.out.println("2: "+((MultivariateNormal)distr).logPdf(sampleValdouble,scaleFactor));
            return  ((MultivariateNormal)distr).logPdf(sampleValdouble,scaleFactor);
    ...
    public final String getPerformanceSuggestion() {
        ...
        // new scale factor
        double newScaleFactor = scaleFactor * ratio;

        DecimalFormat formatter = new DecimalFormat("#.###");
        if (prob < 0.10) {
            return "Try setting window size to about " + formatter.format(newScaleFactor);
        } else if (prob > 0.40) {
            return "Try setting window size to about " + formatter.format(newScaleFactor);
        } else return "";
    }
