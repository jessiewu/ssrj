 ...
 * @author Chieh-Hsi Wu
 */
public class MultiLineSplitMergeRJOperator extends Operator {
    ...
    public Input<ParametricDistribution> paramDistributionInput = new Input<ParametricDistribution>(
            "distr",
    ...
    protected ParametricDistribution paramDistribution;
