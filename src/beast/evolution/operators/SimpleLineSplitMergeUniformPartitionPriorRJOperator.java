 ...
 * @author Chieh-Hsi
 */
public class SimpleLineSplitMergeUniformPartitionPriorRJOperator extends Operator {
    ...
    private double merge(ParameterList parameterList) throws Exception{
        ...
        return Math.log(l -  newCategoryCount)-Math.log(suitableCategoryCount) - Math.log(potentialSplitIndexCount) + parametricDistribution.logDensity(newValue2) + LOG_MERGE_JACOBIAN;
    }
}
